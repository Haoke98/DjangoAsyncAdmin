...
class ProConfig(AppConfig):
    ...
    def ready(self):
        ...
        if 'simplepro.middlewares.SimpleMiddleware' not in settings.MIDDLEWARE:
            ...
            log.warning("Configuration error: Please add `simplepro.middlewares.SimpleMiddleware` to settings.MIDDLEWARE See Documentation: https://simpleui.72wo.com/docs/simplepro/setup.html")
